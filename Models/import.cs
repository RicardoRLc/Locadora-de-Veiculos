...
//             new VeiculoLeve ("Chevrolet", "Onix", 2019, 150.0, "Preta", "TESSTE");
//             new VeiculoLeve ("Chevrolet", "Onix Plus", 2019, 200.0, "Preta", "TESSTE");
//             new VeiculoLeve ("Ford", "Ka", 2019, 120.0, "Vermelho", "TESSTE");
//             new VeiculoLeve ("Renault", "Kwid", 2019, 150.0, "Branco", "TESSTE");
//             new VeiculoLeve ("Hyundai", "HB20", 2019, 150.0, "Preta", "TESSTE");
